...
<style scoped>
    ...
    .formbuilder-button.field-button-fn .btn,
    .save-fn {
        background: #00a3b9;
        padding: 4px 12px;
        width: 80%;
    ...
    .btn.edit-labels:active,
    .btn.load-labels:active {
        box-shadow: none;
        outline: none;
    }
    .select-control {
    ...
    .dir-toggle.forward:before {
        top: 0;
        background: #00ac4d;
    }
    .dir-toggle.stop:before {
        top: 70px;
        background: #da0000;
    }
    ...
    .log-msg {
        ...
        box-shadow: inset 0px 0px 7px #f3d9bc;
        font-size: 9px;
        overflow: auto;
    }
    .note-msg {
    ...
    .ui-slider-vertical {
        ...
        border-radius: 16px;
        margin: 0 auto;
        background: rgba(133, 226, 125, 1);
        background-image: -moz-linear-gradient(
            180deg,
            rgba(255, 0, 0, 1) 10%,
            rgba(251, 126, 0, 1) 25%,
            rgba(250, 207, 0, 1) 40%,
            rgba(133, 226, 125, 1) 60%,
            rgba(0, 245, 249, 1) 80%,
            rgba(0, 67, 255, 1) 100%
        );
        ...
        filter: progid:DXImageTransform.Microsoft.gradient(startColorstr="#ff0000",endColorstr="#0043ff",GradientType=1);
    }
    ...
    .formbuilder-button .btn.add-loco-btn {
        font-size: 12px;
        padding: 9px 7px;
        margin-top: -1px;
    }
    ...
    .btn.acq-loco-btn .icon-circle-right {
        vertical-align: middle;
        padding-bottom: 1px;
        display: inline-block;
        font-size: 17px;
    }
    .btn.acq-loco-btn .icon-cross {
        font-size: 12px;
        padding: 3px;
        display: inline-block;
    }
    /* .add-loco-form:before{
    content: "";
    display: inline-block;
    position: absolute;
    top: -8px;
    ...
    .ui-autocomplete.res-list .ui-menu-item .ui-menu-item-wrapper {
        padding: 5px 15px;
        padding-bottom: 8px;
    }
    .ui-autocomplete.res-list .ui-menu-item .ui-menu-item-wrapper p {
        margin-top: 5px;
        margin-bottom: 3px;
    }
    .ui-autocomplete.res-list .ui-menu-item .ui-menu-item-wrapper .pill {
        margin: 0 10px;
        display: inline-block;
        vertical-align: middle;
    }
    .ui-autocomplete.res-list .ui-menu-item .ui-menu-item-wrapper .pill.wrap {
        max-width: 80px;
        overflow: hidden;
        text-overflow: ellipsis;
        white-space: nowrap;
    }
    .ui-autocomplete.res-list .ui-menu-item .ui-menu-item-wrapper .pill:first-child {
        margin-left: 0;
    }
    .ui-autocomplete.res-list .ui-menu-item .ui-menu-item-wrapper .ac-loco-name {
        color: #007a8a;
    }
    .ui-autocomplete.res-list .ui-menu-item .ui-menu-item-wrapper.ui-state-active .ac-loco-name {
        color: #ffffff;
    }
    .ui-autocomplete.res-list .ui-menu-item .ui-menu-item-wrapper.ui-state-active {
        border: 1px solid #00a3b9;
        background: #00a3b9;
    }
    .ui-autocomplete.res-list-sm {
        max-height: 200px;
        overflow-y: auto;
        overflow-x: hidden;
        z-index: 1010;
    ...
    .ui-autocomplete.res-list-sm .ui-menu-item .ui-menu-item-wrapper {
        padding: 10px 15px;
    }
    .ui-autocomplete.res-list-sm .ui-menu-item .ui-menu-item-wrapper p {
        margin: 0px;
        font-size: 14px;
    }
    .ui-autocomplete.res-list-sm .ui-menu-item .ui-menu-item-wrapper.ui-state-active {
        border: 1px solid #00a3b9;
        background: #00a3b9;
    }
    .settings-group .sno {
    ...
    .settings-group .asst-map {
        padding-top: 1.3%;
        font-size: 14px;
        float: right;
    }
    .settings-group .asst-map p {
        margin: 4px 0;
    }
    .settings-group .asst-map .muted {
        opacity: 0.6;
        font-size: 0.75em;
        vertical-align: text-bottom;
        display: inline-block;
    }
    .settings-heading .option-btns > div {
        padding: 0;
        padding-left: 10px;
    }
    .maps-content span.pill {
